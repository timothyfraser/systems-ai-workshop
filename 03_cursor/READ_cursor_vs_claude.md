...
- **Reach for the local stack** ([module 04](../04_local/README.md)) when the task is **"…and nothing can leave my laptop."**
...
| **Where it runs** | Cloud-coordinated (see [the note](../04_local/README.md#-the-honest-truth-about-cursor-and-local-models)) | Anthropic cloud |
...
3. **Claude Desktop** — step back and review. *"Here's the finished script — what would a reviewer criticize?"* (a mini [red-team](../02_redteam/README.md)).
